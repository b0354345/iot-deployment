 ...
 *******************************************************************************/
package uk.ac.cs.ncl.ccbd.cdt2014.gateway.mqttclient;
...
import uk.ac.cs.ncl.ccbd.cdt2014.gateway.operator.KuraPayloadDecoder;
import uk.ac.cs.ncl.ccbd.cdt2014.gateway.operator.KuraPayloadEncoder;
...
public class KuraMQTTClient implements IKuraMQTTClient {
	 ...
	 */
	public KuraMQTTClient(final String host, final String port, final String clientId, final String username,
	...
	public Map<String, MessageListener> getChannels() {
		return channels;
	}

	public void setChannels(Map<String, MessageListener> channels) {
